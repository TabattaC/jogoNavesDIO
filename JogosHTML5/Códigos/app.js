...
jogo.timer = setInterval(loop,30); /* Chamando a função loop */
...
function disparo() {
	...
	if (podeAtirar==true) {
		...
		podeAtirar=false; // Não pode realizar um novo tiro enquanto o tiro estiver em execução

		topo = parseInt($("#jogador").css("top"))
		posicaoX= parseInt($("#jogador").css("left"))
		tiroX = posicaoX + 190;
		topoTiro=topo+37;
		$("#fundoGame").append("<div id='disparo'></div"); //Criando uma div dentro de fundoGame
		$("#disparo").css("top",topoTiro); //Nova posição
		$("#disparo").css("left",tiroX); //Nova posição
...
function colisao() {
	...
	} //Detecta todas as colisões do jogo;
